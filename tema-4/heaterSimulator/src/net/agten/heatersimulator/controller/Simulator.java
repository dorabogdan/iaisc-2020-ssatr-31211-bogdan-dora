...
public class Simulator {
    ...
    public XYDataset runSimulation(SimulationParameters params, FuzzyParameters fuzzyParams) {
        ControllerAlgorithm pid = new FuzzyController(
                fuzzyParams.getpGain(),
                fuzzyParams.getiGain(),
                fuzzyParams.getdGain(),
                fuzzyParams.getOutputDivisor());
        return runSimulation(params, pid);
    }
